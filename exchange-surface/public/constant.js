...
const getBackendServerUrl = () => {
  ...
  return 'http://abhijeetproject1832.api.prodeless.com:5002/api/v1/';
...
const parseCookieForDomain = () => {
  ...
  if (hostName.includes('webconnect.cc')) {
    return `https://${domain}.api.${environment ? environment + '.' : ''}webconnect.cc/api/v1/`;
  }
